 ...
 * neighboring (left, right, up, down) open sites. We say the system percolates if we fill all open 
 * sites connected to the top row and that process fills some open site on the bottom row. 
 * 
